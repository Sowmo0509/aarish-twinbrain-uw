    ...
    <DashboardLayout>
      <Flex direction={"column"} flex={1} h={"100%"} w={"75%"} my={24} mx={"auto"}>
        ...
        <Flex gap={24} direction={"column"}>
          <Stack gap={0}>
            <Image my={16} mah={rem(480)} radius={"xl"} src={"https://images.unsplash.com/photo-1603732551681-2e91159b9dc2?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"} alt="cover" />
            <Text fw={500} className="max-w-5xl" fz={rem(30)} lh={1.4}>
              NVIDIA reported strong financial results for Q2 FY24 with a significant growth in revenue, primarily driven by its Data Center segment.
            </Text>
